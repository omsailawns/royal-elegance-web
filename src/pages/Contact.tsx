    ...
    <PageWrapper>
      <section className="py-20 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          >
            <span className="text-gold tracking-[0.2em] uppercase text-sm font-medium">Book Your Event</span>
            <h2 className="font-display text-4xl md:text-5xl font-bold mt-3 mb-4">
              Let's Create <span className="gold-text">Magic</span>
            </h2>
            <p className="text-muted-foreground">
              Fill in the details and our team will reach out to plan your perfect event.
            </p>
          </motion.div>
          ...
          {submitted ? (
            ...
            >
              ...
              <button
                onClick={() => { setSubmitted(false); setForm({ name: "", phone: "", eventType: "", date: "" }); }}
                className="mt-6 gold-gradient px-6 py-3 rounded-xl text-primary-foreground font-medium glow-hover"
              >
            ...
            >
              {[
                ...
                <div key={field.key}>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-background border border-border focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all duration-300 font-body"
                  />
                </div>
              ))}
              ...
              <button
                type="submit"
                className="w-full gold-gradient px-6 py-4 rounded-xl text-primary-foreground font-semibold text-lg glow-hover flex items-center justify-center gap-2"
              >
                Book Your Event <Send size={20} />
              </button>
            </motion.form>
          )}
        </div>
